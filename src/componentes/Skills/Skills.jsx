      ...
      <div className="skills-info-contenedor">
        <div className="skills-info-contenido-contenedor">
          ...
          <div className="skills-info-contenido-logos">
            ...
            <Modal estado={modalHtml} cambiarEstado={setModalHtml} imagen={`${html}`} descripcion='Es un lenguaje de marcado para la elaboración de páginas web. Define una estructura básica y un código (denominado código HTML) para la definición de contenido de una página web, como texto, imágenes, videos, juegos, entre otros'/> 
            ...
            <Modal estado={modalCss} cambiarEstado={setModalCss} imagen={`${css}`} descripcion='Es un lenguaje de diseño gráfico para definir y crear la presentación de un documento estructurado escrito en un lenguaje de marcado. Es muy usado para establecer el diseño visual de los documentos web, e interfaces de usuario escritas en HTML'/> 
            ...
            <Modal estado={modalJs} cambiarEstado={setModalJs} imagen={`${javascript}`} descripcion='Es un lenguaje de programación interpretado, dialecto del estándar ECMAScript. Se define como orientado a objetos, basado en prototipos, imperativo, débilmente tipado y dinámico. Se utiliza principalmente del lado del cliente, implementado como parte de un navegador web permitiendo mejoras en la interfaz de usuario y páginas web dinámicas.'/> 
            ...
            <Modal estado={modalTs} cambiarEstado={setModalTs} imagen={`${typescript}`} descripcion='Es un superconjunto de JavaScript, que esencialmente añade tipos estáticos y objetos basados en clases.'/> 
            ...
            <Modal estado={modalVite} cambiarEstado={setModalVite} imagen={`${vite}`} descripcion='Es una herramienta para Frontend que permite crear aplicaciones de Javascript usando algún framework o libreria como ReactJs, Vuejs, Angular ya sea con algún framework especifico o Vanillajs.'/> 
            ...
            <Modal estado={modalVSCode} cambiarEstado={setModalVSCode} imagen={`${vscode}`} descripcion='Es un editor de código fuente.'/> 
            ...
            <Modal estado={modalGit} cambiarEstado={setModalGit} imagen={`${git}`} descripcion='Es un software de control de versiones. Su propósito es llevar registro de los cambios en archivos de computadora incluyendo coordinar el trabajo que varias personas realizan sobre archivos compartidos en un repositorio de código.'/> 
            ...
            <Modal estado={modalGithub} cambiarEstado={setModalGithub} imagen={`${github}`} descripcion='Es una forja (plataforma de desarrollo colaborativo) para alojar proyectos utilizando el sistema de control de versiones Git.'/> 
            ...
            <Modal estado={modalWordpress} cambiarEstado={setModalWordpress} imagen={`${wordpress}`} descripcion='Es un sistema de gestión de contenidos, enfocado a la creación de cualquier tipo de página web'/> 
