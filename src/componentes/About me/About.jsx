  ...
  return(
    <section className="aboutMe-contenedor" id='about-me'>
      <div className="aboutMe-info-contenedor">
        ...
        <p className="aboutMe-info-texto">Cuando comencé a programar descubrí un mundo con un montón de posibilidades para explorar mis conocimientos y creatividad. Desde entonces, me encuentro envuelto en un aprendizaje constante permitiendome perfeccionarme como desarrollador web.</p>
      </div>
